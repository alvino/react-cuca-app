  ...
  return (
    <div>
      <div className="btn-group mb-5" role="group">
        <Button variant='secondary' size='lg' onClick={() => history.goBack()}>Voltar</Button>
        <Button size='lg' onClick={handleImprimir}>Imprimir</Button>
      </div>
      ...
      <div className='bg-primary 
        ...
        <div>
          ...
          <div>
            <FaEnvelope className='mx-2' /><span>cuca_altohorizonte@gmail.com</span>
          </div>
          <div>
            <FaFacebook className='mx-2' /><span>cuca_altohorizonte</span>
          </div>
          <div>
            <FaInstagram className='mx-2' /><span>@cuca_altohorizonte</span>
          </div>
          <div>
            <FaMapMarkedAlt className='mx-2' /><span> Av. Getulio Vargas, 82 - Centro</span>
          </div>
        </div>
      </div>
      ...
      <div className=' mb-auto'>
        ...
        <p className='h4 my-2'>Codigo: <NumberFormat format='###########' value={id} /></p>

        <p className='text-right'>Alto Horizonte-GO, {dataOrcamento}</p>
        <p className='text-right text-muted'>Valido por 30 dias (ou ate dura o estoque)</p>
        ...
        <div className='mt-3'>
          ...
          <p className='text-right font-weight-bold'>
            <span className='h4'> <NumberFormat value={orcamento.amount} /> </span>
          </p>
...

              {
                listaPedido.map((produto, index) => (
                  <tr key={index}>
                    ...
                    <td><NumberFormat value={produto.quantity} prefix='' /></td>
      ...
      <Button className='mt-5' size='lg' onClick={handleImprimir}>Imprimir</Button>
    </div >
  )
}
